...
void setup() {
  ...
  pinMode(6, INPUT);     //Setting pin 10 as the input pin for the sliding switch controlling the base of the catch compartment.
  
  pinMode(7, INPUT_PULLUP);  //Setting pin 11 as the input pin for the pushbutton that represents the state of the retrieval compartment (opened / closed)
       
  pinMode(8, OUTPUT);      //Setting pin 12 as the output pin for the red LED that indicates the thermal state of the vaccines.
                        
  pinMode(9, OUTPUT);     //Setting pin 23 as the output pin for the blue LED that indicates the access state of the retrieval compartment.
